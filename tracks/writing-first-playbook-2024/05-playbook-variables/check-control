...
if [ -f "$target_file" ]; then
    ...
    if [ "$file_content" != "$solve_content" ]; then
        fail-message "Challenge 1.4 - The 'system_setup.yml' file does not have the proper content. Please check the file and try again."
    fi
else
    fail-message "Challenge 1.4 - The 'system_setup.yml' file does not exist in the specified directory."
fi
