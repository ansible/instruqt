...
notes:
- type: text
  contents: Enjoy the rest of your time playing with Ansible!
tabs:
- title: control
  type: terminal
  hostname: control
...
👋 Introduction
===
Feel free to take the rest of the time and explore what you can do with an Ansible playbook.

Did you know you could access Ansible documents directly from the man pages?

For example, imagine you wanted to learn more about downloading files from the web?
