...
id: orxcgwzpeadv
type: challenge
title: 9. Event-Driven Ansible - ansible-rulebook
...
3. Finally, Verify the `localhost` entry exists in your `hosts` file. The content of the `/home/student/aap_workshop/hosts` file should be the following:
