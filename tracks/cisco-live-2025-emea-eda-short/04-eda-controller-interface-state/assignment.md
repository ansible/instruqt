...
id: bkl0gazwztxp
type: challenge
title: 4 - Automation Decisions - Rulebook Activations
teaser: Create a rulebook activation and remediation job template
notes:
- type: text
  contents: |-
...
---
4 - ⚡ Automation Decisions - Rulebook Activations
===
...
5. **Click the third icon** on the sidebar (ref. 1 in image below). We will commit our changes  to our repository.
6. Add a descriptive **message** of what you are changing (ref 1 below) and click the blue **Commit** button (ref 2  below)
...
1. Switch to the [button label="VS Code"](tab-5) tab
2. You will be in the Git section of VS Code, switch to the file **Explorer**  (first icon on the left sidebar)
